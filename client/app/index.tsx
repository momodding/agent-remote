...
import { ActivityIndicator, Alert, AppState, FlatList, Pressable, SafeAreaView, StyleSheet, Text, TextInput, useWindowDimensions, View } from 'react-native';
...
export default function Dashboard() {
  ...
  <View style={styles.controls}><TextInput style={styles.search} value={query} onChangeText={setQuery} placeholder="Search sessions" placeholderTextColor="#888" /><Pressable accessibilityLabel="New shell" style={styles.primary} onPress={() => void create()}><Text style={styles.primaryText}>New shell</Text></Pressable></View>
